...
var _title = ""
var _creator = ""
var _pageSize = Vector2i(1400,1020)
...
func newImage(pageNum : int, imagePosition, baseImage : Image, imageSize = null):
	...
	var image = _image.new(Vector2i(imagePosition.x, _pageSize.y-imageSize.y-imagePosition.y), imageSize, baseImage.get_data(), baseImage.get_format())
